...
logger = logging.getLogger("grace2_agent.tools.discover_dataset")
...
def _default_corpus_path() -> Path:
    ...
    return here.parent.parent / "data" / "tool_query_corpus.yaml"
...
def _get_persistence_safe() -> Any:
    ...
    """
    try:
        from ..server import get_persistence as _server_get_persistence  # type: ignore[import-not-found]
...
async def _fetch_recent_telemetry_docs(
    ...
    *,
    ...
    try:
        ...
        from ..persistence import DEFAULT_DATABASE, _unwrap_mcp_result
...
async def get_dynamic_hot_set(
    ...
    *,
    ...
    try:
        from ..categories import HOT_SET_TOOLS as _STATIC_HOT_SET
