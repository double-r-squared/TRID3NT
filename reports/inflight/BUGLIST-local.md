...
| F26 | State-scale coarsened NLCD renders nodata/ocean as OPAQUE BLACK rectangle (mobile screenshot proof; regression suspect = 21cd123 auto-coarsen path losing nodata/colormap alpha) | IN-PROGRESS | seen on WA fetch 150m; fix agent dispatched (COG writer nodata + transparent alpha; TiTiler seam check) |
