...
logger = logging.getLogger("grace2_agent.workflows.run_landlab")
...
#: GRACE2_AWS_BATCH_JOB_DEF_LANDLAB (the shared-append snippets) — NOT this lane.
...
def stage_landlab_manifest(
    ...
    *,
    ...
    ``GRACE2_CACHE_BUCKET`` staging bucket the SFINCS/SWMM decks upload land in.
