...
| job-0070-engine-20260607 | engine | **OQ-69-COG-CRS-MISTAG closure (the actual headline unlock):** re-run M5 smoke to regenerate flood COG (job-0063 fix now in place) → trigger publish-raster on the fresh COG → drive dev UI → capture Fort-Myers-with-flood headline screenshot. Pure regeneration job, no code changes. | job-0069 | assigned |
