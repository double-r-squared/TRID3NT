...
| job-0075-engine-20260607 | engine | **Visible-corrections verification:** re-run M5 smoke harness → fresh COG with 0071 rotation + transparency fixes baked in → publish-raster via auto-dispatch (first live test of 0071's fix) → Playwright re-screenshot. Closes the visible-demo gap from 0074's honest caveat. Pure regeneration. | job-0074 | assigned |
