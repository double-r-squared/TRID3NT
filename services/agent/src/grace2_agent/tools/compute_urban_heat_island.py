...
logger = logging.getLogger("grace2_agent.tools.compute_urban_heat_island")
...
def compute_urban_heat_island(
    ...
    **Errors (FR-AS-11):** ``UhiAoiTooLargeError`` / ``UhiInputError`` (bad
    ...
    with tempfile.TemporaryDirectory(prefix="grace2_uhi_") as tmpdir:
        ...
        try:
            ...
            if lst_uri is not None:
                ...
                try:
                    from .fetch_modis_lst import fetch_modis_lst
