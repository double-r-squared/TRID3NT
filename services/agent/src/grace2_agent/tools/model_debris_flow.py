...
logger = logging.getLogger("grace2_agent.tools.model_debris_flow")
...
def _severity_from_mtbs(
    ...
    try:
        from .fetch_mtbs_burn_severity import MTBSError, fetch_mtbs_burn_severity
    except Exception as exc:  # noqa: BLE001
...
def model_debris_flow(
    ...
    **_extra_ignored: Any,
    ...
    with tempfile.TemporaryDirectory(prefix="grace2_debris_flow_") as tmpdir:
